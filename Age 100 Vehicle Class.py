...
def transpose_rows_to_columns(input_file, output_file):
    ...
    if 'Number of Vehicles' in df_transposed.iloc[0].values:
        ...
        # Extract unique name from 'Vehicle Class Name' column
        df_filtered['Unique Name'] = df_filtered['Vehicle Class Name'].apply(extract_unique_name)

        # Rearrange the DataFrame based on the 'Unique Name' column
        df_filtered.sort_values(by=['Unique Name'], inplace=True)
